class InsightsLoader {
    ...
    async loadInsightsList() {
        try {
            const files = [
                '2024-04-08-ai-apt-representative-en.md',
                '2025-08-14-serena-mcp-guide-en.md'
            ];
                    ...
                    <div class="article-grid">
                        <div class="article-item">
                            <a href="articles/ai-apt-representative.html" class="article-link">
                                <h4 class="article-title">Apartment Representative Work Enhanced by AI</h4>
                                <p class="article-meta">AI and Community Management | April 2024</p>
                            </a>
                        </div>
                    </div>
                `;
