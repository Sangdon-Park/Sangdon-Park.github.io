...
\vspace{0.3cm}
AI Research Engineer, Sayberry Games Inc.\\
\vspace{0.3cm}\\
\faEnvelope\ \href{mailto:chaos@sayberrygames.com}{chaos@sayberrygames.com} \hfill \faPhone\ +82-10-2523-3824 \\[0.2cm]
...
\textit{August 2017 -- April 2025} \hfill \textit{Advisor: Jun Kyun Choi}
...
Dr. Sangdon Park is an AI researcher specializing in LLM applications, edge computing, and interactive AI systems. He received his Ph.D. from KAIST in 2017, focusing on energy trading systems and electricity markets in microgrids. From 2017 to April 2025, he served as a post-doctoral researcher at KAIST, where he was awarded the prestigious \textbf{Sejong Science Fellowship} (NRF Korea) in March 2022, receiving approximately \$120,000 per year for up to 5 years as principal investigator.

Dr. Park's expertise in AI technologies is demonstrated through his extensive \textbf{invited talks and seminars} at major universities across Korea, including 9 AI seminars from 2023 to 2025 at institutions such as KAIST AI Semiconductor Department, Kyung Hee National University, and Chungnam National University. These presentations showcase his ability to communicate complex AI concepts effectively to diverse academic audiences.

As a pioneer in AI-driven development, Dr. Park demonstrated exceptional capabilities in \textbf{vibe coding}—the ability to rapidly transform creative concepts into functional prototypes using AI tools. His mastery of this innovative coding approach enabled him to complete an \textbf{Edge Computing GUI Simulator} in just one month (previously estimated as a 4-year project) and create the \textbf{AI Character Conversations} project, which generates natural character interactions beyond simple dialogues. He expertly leverages multiple LLM platforms (ChatGPT, Claude, Gemini) and AI coding assistants to achieve 10x development productivity.

Currently at \textbf{Sayberry Games Inc.} (since May 2025), Dr. Park applies his AI expertise to develop innovative game technologies for a 300 million KRW \textbf{AI game development project}. His research interests include LLM-based system design, AI character development, interactive AI systems, and enhancing development productivity through vibe coding methodologies. He continues to bridge theoretical rigor with cutting-edge AI applications, positioning himself as a thought leader in the AI community.
...
₩50,000,000 (Korean Won) per year $\approx$ \$200,000 (US Dollars), for 4 years & \\
...
₩45,000,000 (Korean Won) total $\approx$ \$45,000 (US Dollars) for 1.5 years & \\
\end{tabular}
